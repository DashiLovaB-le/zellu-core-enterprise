...
const name = "016_set_employee_job_title";
const sql = readFileSync(resolve(root, "supabase/migrations/016_set_employee_job_title.sql"), "utf8");
...
if (names.has(name)) {
  console.log(`Skip ${name} (já aplicada)`);
} else {
