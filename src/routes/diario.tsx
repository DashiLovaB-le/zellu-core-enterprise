...
const CONVERSATIONS = [
  {
    when: "Ontem, 20:30",
    excerpt: '"Me senti um pouco ansiosa com a reunião de amanhã, mas respirei…"',
    tint: "var(--clay-self)",
  },
  {
    when: "Segunda, 09:15",
    excerpt: '"Acordei com bastante energia. Planejei a semana toda de forma…"',
    tint: "var(--clay-cta-2)",
  },
  {
    when: "Domingo, 18:00",
    excerpt: '"Tarde tranquila com a família. Senti gratidão pelos pequenos…"',
    tint: "var(--clay-joy)",
  },
];
  ...
  return (
    <MobileShell>
      ...
      <section className="mb-6 p-5 clay-card">
        ...
        <p className="text-[15px] leading-relaxed text-[var(--clay-text)]">
          Notamos que nas últimas terças-feiras seu humor fica um pouco mais tenso.
          Que tal agendarmos um momento de autocuidado maior para o início da semana?
        </p>
      </section>
          ...
          {CONVERSATIONS.map((c, i) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="mt-0.5 text-sm leading-snug text-[var(--clay-text)]">
                  {c.excerpt}
                </p>
              </div>
