      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex gap-1">
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg bg-white/50 text-xs font-bold text-[var(--clay-title)]/60"
          >
            −
          </button>
          <button
...
function MoodCard({ mood, onMoodChange }: BemEstarPageProps) {
  return (
    <section className="rounded-2xl bg-white/70 p-4 shadow-sm backdrop-blur-md">
      <h2 className="font-display text-sm text-[var(--clay-title)] mb-2">😌 Humor</h2>
    ...
    <section className="rounded-2xl bg-white/70 p-4 shadow-sm backdrop-blur-md">
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="mt-0.5 text-xs font-semibold text-[var(--clay-anxiety)]">
            {movementMinutes} min
          </p>
        </div>
      </div>
...
function RespiroCard() {
  return (
    <a
      href="/respiro"
      className="flex items-center gap-3 rounded-2xl bg-gradient-to-br from-[#C5D9F1]/30 to-[#D7CBE8]/30 p-4 shadow-sm backdrop-blur-md"
    >
